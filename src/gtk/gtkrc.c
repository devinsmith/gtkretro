...
gtk_rc_get_theme_dir(void)
{
  ...
  if (var)
    ...
    path = g_strdup_printf("/usr/local/share/themes");
...
gtk_rc_get_module_dir(void)
{
  ...
  if (var)
    ...
    path = g_strdup_printf("/usr/local/gtk/themes/engines");
...
gtk_rc_append_default_pixmap_path(void)
{
  ...
  if (var)
    ...
    path = g_strdup_printf("/usr/local/share/gtk/themes");
...
gtk_rc_add_initial_default_files (void)
{
  ...
  if (var)
    ...
    {
      str = g_strdup_printf ("/usr/local/gtk/gtkrc");
